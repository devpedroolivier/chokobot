...
TORTAS_ALIASES: Dict[str, str] = {
    ...
    "argentino": "Argentina",
    "banoffee": "Banoffee",
    "cheesecake": "Cheesecake Tradicional Versão Baixa",
    "cheesecake tradicional": "Cheesecake Tradicional Versão Baixa",
    "cheesecake tradicional baixa": "Cheesecake Tradicional Versão Baixa",
